  ...
  return (
    <>
      ...
      >
        <Confetti
          active={showConfetti}
          config={{ elementCount: 200, spread: 230 }}
        />
        Welcome
      </div>
      ...
      <div className="mt-20 flex flex-col items-center md:grid  text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        <div className="lg:col-span-3 md:col-span-4 md:row-span-2 md:row-end-2">
          <Phone
            className={cn(`bg-${tw}`, "max-w-[9.40rem] md:max-w-full")}
            ...
            <div className="bg-gray-100 p-6 sm:rounded-lg sm:p-8">
              <div className="flow root text-sm">
                ...
                <div className="flex justify-between items-center py-2">
                  <p className="font-semibold to-gray-900">Order total</p>
                  <p className="font-semibold to-gray-950">
