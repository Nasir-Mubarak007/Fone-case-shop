    ...
    <div className="relative my-20 grid grid-cols-1 lg:grid-cols-3  pb-20">
      <div ref={containerRef} className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]" >
          <AspectRatio
            ref={phoneCaseRef}
            ratio={896 / 1831}
            className="pointer-events-none relative z-50 aspect-[896/1831] w-full h-full"
          >
            <NextImage
              alt="phone image"
              src={Phone}
          ...
          <div className="absolute z-40 inset-0 left-[0..2rem] top-px right-[0.2rem] bottom-px rounded-[2rem] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]" />
          <div
            className={cn(
              "absolute inset-0 left-[0..2rem] top-px right-[0.2rem] bottom-px rounded-[2rem]",
              `bg-${options.color.tw}`
            )}
          />
        </div>
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
        <ScrollArea className="relative flex flex-1 overflow-auto ">
          <div
            className="absolte z-10 inset-x-0 h-12 bg-gradient-to-t from-white pointer-events-none"
            aria-hidden="true"
          />
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          key={model.label}
                          className={cn(
                            "flex text-sm gap-1 items-center p-1.5 cursor-defaulthover:bg-zinc-200",
                            {
                              "bg-zinc-200":
