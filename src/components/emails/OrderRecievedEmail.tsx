...
const OrderRecievedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV == "development"
      ? "http://loalhost:3000"
      : "https://fone-case-shop.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your package is shipped. Delivery usually 3 days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If You have any questions or inquiries regarding your order,
              please reach out to us with your order number and we're here to
              help.
            </Text>
          </Section>
          <Hr style={global.hr} />
